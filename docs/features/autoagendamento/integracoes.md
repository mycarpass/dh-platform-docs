...
Endpoints da **DH API** (`reforged-api`) que o autoagendamento consome ou vai precisar. Esta página é uma referência de produto — o objetivo é deixar claro **de onde vêm os dados** de cada etapa e **o que ainda falta**.
